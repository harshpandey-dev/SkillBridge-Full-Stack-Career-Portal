  ...
  if (initialLoading) {
    return (
      <div className="space-y-5 max-w-[860px] animate-pulse">
        <div className="h-8 bg-[#F2F4F7] rounded w-1/3" />
        <div className="bg-white border border-[#E4E7EC] rounded-lg p-6 space-y-4">
          <div className="h-10 bg-[#F2F4F7] rounded" />
          <div className="h-10 bg-[#F2F4F7] rounded" />
          <div className="h-32 bg-[#F2F4F7] rounded" />
        </div>
      </div>
    )
  }
        ...
        <div className="bg-white border border-[#E4E7EC] rounded-lg p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-[#E4E7EC] rounded px-3 py-2.5 text-sm outline-none focus:border-[#2563EB]"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-[#E4E7EC] rounded px-3 py-2.5 text-sm text-[#172033] outline-none focus:border-[#2563EB]"
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="130,000"
                  className="w-full border border-[#E4E7EC] rounded pl-7 pr-3 py-2.5 text-sm outline-none focus:border-[#2563EB]"
                />
              </div>
              <div className="relative">
                <span className="absolute left-3 top-2.5 text-sm text-[#94A3B8]">$</span>
          ...
          <div>
            ...
            <input
              ...
              className="border border-[#E4E7EC] rounded px-3 py-2.5 text-sm outline-none focus:border-[#2563EB] text-[#172033]"
            />
          </div>
        ...
        <div className="bg-white border border-[#E4E7EC] rounded-lg p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-[#E4E7EC] rounded px-3 py-2.5 text-sm outline-none focus:border-[#2563EB] resize-none"
            />
          ...
          <div className="flex justify-between pt-2">
            <button
              type="button"
              onClick={() => setStep(1)}
              className="border border-[#E4E7EC] text-[#667085] px-5 py-2.5 rounded text-sm font-medium hover:bg-[#F7F8FA] transition-colors"
            >
              ← Back
            </button>
            <button
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="border border-[#E4E7EC] text-[#667085] px-5 py-2.5 rounded text-sm font-medium hover:bg-[#F7F8FA] disabled:opacity-60 transition-colors"
              >
                Save as draft
              </button>
              <button
                ...
                className="bg-[#163A5F] text-white px-6 py-2.5 rounded text-sm font-semibold hover:bg-[#0F2A45] disabled:opacity-60 transition-colors"
              >
